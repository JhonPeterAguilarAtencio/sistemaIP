 ...
 ?>
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Mantenimiento del Mouse</h1>
                            ...
                            <div class="panel-body table-responsive" id="listadoregistros">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="header-title mt-0">Detalles del Mouse</h4>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-lg-11">
                                                <div class="card-body">
                                                <h4 class="mt-0 header-title">Datos del Mouse</h4>
                                                    ...
                                                    <div class="row clearfix">
                                                        <div class="form-group">
                                                            <label>Imagen</label>
                                                            <input type="file" class="form-control-file" name="Mimagen" id="Mimagen">
                                                            <input type="hidden" name="Mimagenactual" id="Mimagenactual">
                                                            <br></br>
                                                            <img src="" width="150px" class="rounded" alt="Eniun" height="120px" name="Mimagenmuestra" id="Mimagenmuestra">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script type="text/javascript" src="../scripts/smouses.js"></script>
