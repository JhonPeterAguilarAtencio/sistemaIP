...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Menu WILAN 8-->
            <!--<li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities"
                    aria-expanded="true" aria-controls="collapseUtilities">
                    <i class="fas fa-fw fa-wrench"></i>
                    <span>Registro IPv4 Wilan 8</span>
                </a>
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Registro IPv4 Wilan 8:</h6>
                        <a class="collapse-item" href="utilities-color.html">Sub Gerencia de TI</a>
                        <a class="collapse-item" href="utilities-border.html">SubGerencia de </br>Tecnologia de la </br>Informacion</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header"><i class="fa fa-users"></i>  Registro Usuarios</h6>
                        <a class="collapse-item" href="../usuario/persona.php"><i class="fa fa-user-plus"></i>   Agregar Personas</a>
                        <a class="collapse-item" href="../usuario/Uagregarylistar.php"><i class="fa fa-user-plus"></i>  Agregar Usuarios</a>
                        <a class="collapse-item" href="../usuario/permiso.php"><i class="fa fa-unlock-alt"></i>  permisos Usuario</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTre" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header"><i class="fa fa-cogs"></i>  Mantenimiento sistema</h6>
                        <a class="collapse-item" href="../sistema/areas.php"><i class="fa fa-building"></i>  Registrar Areas</a>
                        <a class="collapse-item" href="../usuario/Uagregarylistar.php"><i class="fa fa-user-plus"></i>  otros</a>
                    </div>
                </div>
            </li>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                    ...
                    <img class="img-profile rounded-circle" src="../../files/usuario/<?php echo $_SESSION['Uimagen']; ?>">
                </a>
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                    ...
                    <a class="dropdown-item" href="../../ajax/xusuario.php?op=salir" data-toggle="modal" data-target="#logoutModal">
