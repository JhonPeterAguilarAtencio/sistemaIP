 ...
 ?>
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Mantenimiento de Laptops</h1>
                            ...
                            <div class="panel-body table-responsive" id="listadoregistros">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="header-title mt-0">Detalles de la Laptop</h4>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-lg-11">
                                                <div class="card-body">
                                                <h4 class="mt-0 header-title">Datos de la Laptop</h4>
                                                    <div class="row clearfix">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Tipo de Codigo:(*)</label>
                                                                <input type="hidden" name="idlaptop" id="idlaptop">
                                                                <select class="form-control selectpicker" data-live-search="true" id="idtipocodigo" name="idtipocodigo">
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
...
<script type="text/javascript" src="../scripts/slaptop.js"></script>
<?php
 }
 ob_end_flush();
?>